...
/*   Updated: 2025/04/02 02:32:44 by rexposit         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	find_min_stack(int *stack, int size, int *min_value, int *min_index)
{
	int	i;
...
void	sort_five(int **stack_a, int **stack_b, int *size_a, int *size_b)
{
	...
	if (*size_a == 4)
	{
		find_min_stack(*stack_a, *size_a, &min_value, &min_index);
